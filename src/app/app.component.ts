...
export class AppComponent {
  projects: Project[] = [
    ...
    },
    {
      ...
      description: `I was responsible for developing a Speed Test application for Charter customers, designed to measure the upload and download speeds of their Wi-Fi modems and routers. The user interface was built using Angular, ensuring a seamless and responsive experience. I implemented state management with NgRx and created reusable components to enhance maintainability. Additionally, I worked with both reactive and template-driven forms to handle user input, integrated GraphQL APIs with Java for real-time data updates, and optimized performance using lazy loading and RxJS Observables. I also ensured cross-browser compatibility and conducted unit and end-to-end testing using Jasmine and Karma.

      On the backend, I worked with AWS services such as S3, Lambda, and API Gateway. I also used AWS for cloud infrastructure, leveraging S3 for hosting and CloudWatch for monitoring application performance, ensuring that our services remained highly available and optimized. By streamlining the development process with Angular CLI and optimizing build performance with Webpack, I contributed to delivering a robust and efficient application that significantly improved customer satisfaction.`
    },
    {
      ...
      On the backend, I developed RESTful APIs with Node.js and Express.js, integrated MongoDB for data management, and used Node.js’s asynchronous capabilities with Promises and async/await for efficient data processing. For cloud infrastructure, I used AWS S3 for hosting and AWS CloudWatch for monitoring performance, ensuring high availability and optimization. I also contributed to unit and integration testing with Mocha, and integrated CI/CD pipelines with Jenkins and GitLab to automate testing, deployment, and monitoring. Throughout, I participated in code reviews to share knowledge and best practices within the team.`
    },
    {
